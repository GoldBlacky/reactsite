...
import DrawSVGPlugin from 'gsap-trial/DrawSVGPlugin' // Import DrawSVGPlugin from 'gsap' instead of 'gsap-trial'
  ...
  return (
    <div className="logo-container">
      <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 396.9 1139.5"
      >
        <g className="svg-container" fill="none">
          <path
            ref={path1}
            d="M245.1,67.7L224.2,2.8v52c0,0-12.1,6.6-18.1,10.1c-5.2,3-13.4,10.5-19.3,9.8l0.2,0.2l-0.2-0.2
          ...
          <path
            ref={path2}
            className="st0"
            d="M347.6,802.3c5.8,0,15.2-11.8,19.1-16c6.8-7.2,12.5-15.3,16.6-24.3c4.1-9.1,6.7-18.7,5.4-28.7
          ...
          <path
            ref={path3}
            className="st0"
            d="M376.9,16.7c28.3,13.7,18.1,58,4.4,77.9c-18.6,27-48.5,45.1-74.4,64.3c-3.4-5.6-7.7-10.3-9.3-16.9
          ...
          <path
            ref={path4}
            className="st0"
            d="M376.4,426.3c12.6,1.7,17.9,23.4,18.4,33.5c0.8,15-4.4,30.2-12.6,42.6c-18.4,27.8-49.1,46.2-75.2,65.8
          ...
          <path
            ref={path5}
            className="st0"
            d="M263.4,344.6c-5-8.2-9.8-16-15.3-25c13.5,0,25.9,0,39.2,0c-7.7-10.8-15.7-23.5-9.2-37.1
          ...
          <path
            ref={path6}
            className="st0"
            d="M300.6,609.2c16.6-20.4,38.1-5.6,46.3,14.4c4.4,10.9,2.8,20.2,0.3,31.2c-1.8,8.1-0.5,14.4,1.2,22.5
          ...
          <path
            ref={path7}
            className="st0"
            d="M293.1,1115.2c-6.3-9.7-12.5-19.3-18.8-29.1c1.2-0.9,2.2-1.6,2.8-1.9c-3.2-11.4-9.4-24.5-0.7-35.1
          ...
          <path
            ref={path8}
            className="st0"
            d="M336.1,880.4c4.4,6.1,8.4,11.7,12.7,17.8c-3.6,2.8-7.1,5.5-10.8,8.3c12.2,14.1,20.6,39.9,0.5,52.4
          ...
          <path
            ref={path9}
            className="st0"
            d="M350.2,477.7c-2.8,22.1-14.2,42.8-40,39.6c-22.3-2.8-38.6-24.8-39.3-46.6c-0.8-21.7,20.1-39.5,41.6-37
				C333.5,436.2,350.9,456.7,350.2,477.7z M338.3,470.9c-0.1-36.6-59.2-20.6-55.7,9.8C286.4,514.7,339.6,501.1,338.3,470.9z"
          />
          <path
            ref={path10}
            className="st0"
            d="M282.5,47.9c3.5,4.5,6.2,9.5,9.2,14.4c-8.6,4-15.5,10.1-13.4,20.6c1.8,9.2,11.2,13.6,16.7,4.3
          ...
          <path
            ref={path11}
            className="st0"
            d="M305.5,1018.7c0-9.1,0-18.1,0-27.2c8.4,3.5,10.3,12.2,11.8,20c0.7,3.5-1.4,6.9,3.1,7.4
          ...
          <path
            ref={path12}
            className="st0"
            d="M305.7,243.7c0-8.9,0-18,0-28.1c8.9,7.4,8.2,13.9,11.8,23.2c3.4,8.6,8.6,3.8,12.4-3
          ...
          <path
            ref={path13}
            className="st0"
            d="M291.5,433.7c-4.8-5.5-10.9-11-14.9-17.1c-4.3-6.5-3.5-12.6-3.4-20.2c0.1-17.4,0-34.8,0-52.2
          ...
          <path
            ref={path14}
            className="st0"
            d="M291.4,433.6c0.1-0.1,0.2-0.1,0.3-0.2c0,0.1-0.1,0.2-0.1,0.3C291.5,433.7,291.4,433.6,291.4,433.6z"
          />
          <path
            ref={path15}
            className="st0"
            d="M376.5,426.1c0.1,0.1,0.1,0.2,0.2,0.3c-0.1,0-0.1,0-0.2-0.1C376.4,426.3,376.5,426.1,376.5,426.1z"
          />
          <path
            ref={path16}
            className="st0"
            d="M63.5,729.3c-1.2,0.4-2.2-0.1-2.5-1.9c-1.2-8.2-2.1-16.4-3-24.6c-0.5-4.7-4.5-21-1.6-25
          ...
          <path
            ref={path17}
            className="st0"
            d="M161.6,819.8c2.2-0.5,4.8-2.3,6.7-3.3c0.5,16.1-7.3,31-8.8,46.9c0.5,0.4,1.1,0.9,1.6,1.3
          ...
          <path
            ref={path18}
            className="st0"
            d="M208.3,952.6c1.3-20.8,5.1,13.6,8.3,26c0.3,1.2-1,2.2-2,1.5c-6.6-4.4-9-15.4-11.7-22.2
				c-5.1-12.9-12-24.2-19.3-35.8c-1.4-2.2-6.2-7.8-4.5-10.4c3.3-5.2,8.6,3.7,10.3,5.9C196.8,927.5,202.8,941.5,208.3,952.6z"
          />
          <path
            ref={path19}
            className="st0"
            d="M140.2,689.4c5.8-3.3,9.9-4.4,2.8,10.9c-2.1,3.7-4.8,7.6-8.4,10c-0.8,0.5-1.9,0.1-2.1-0.9
				c-1.5-6.7,1.5-14.7,2-21.4c0.5-7.9-1.2-18.8,1.6-26.6c0.4-1.2,2.2-1.2,2.7,0C142.2,669.3,140.2,681,140.2,689.4z"
          />
          <path
            ref={path20}
            className="st0"
            d="M210,740.1c-13.1-22.9-19-56.6-15-71.7c0.3-1,1.6-1.3,2.2-0.6c2.3,2.6,0.1,11.9,0.2,14.6
				c0.1,7.2,0.9,14.3,2.3,21.4c2.5,12.5,7.7,23.9,11.2,36.1C210.9,740.9,210.6,740.9,210,740.1z"
          />
          <path
            ref={path21}
            className="st0"
            d="M214,765.1c0.3,0.6-0.5,1-0.9,0.5c-5.6-8.2-10.5-17-14.3-26.2c-3.1-7.5-9.2-19.5-7.9-28
				c0.1-0.7,1.1-0.9,1.4-0.3c4.8,8.9,6.3,20.6,10.2,29.9L214,765.1z"
          />
          <path
            ref={path22}
            className="st0"
            d="M211.1,675.3c-2.4,9.8,2,35.7,10.6,51.9c0,1.6-1.3,1.3-1.8,0.7c-7.7-14-15.6-37-12.2-50.4
				c0.4-1.7,1.2-3.4,2.1-4.9C210.5,671.7,212,671.6,211.1,675.3z"
          />
          <path
            ref={path23}
            className="st0"
            d="M194.6,460.6c-4.4,8.5-11.4,6.9-17.6,7.4c0.9,4.3,1.7,8.5,2.7,13c-11.6,4.5-18.1,14.5-29.5,19.7
          ...
          <path
            ref={path24}
            className="st0"
            d="M83.9,388.7c20,1.1,36.8,6.9,53.7,17.4c7.9,4.9,15.7,9.7,24.5,12.9c8.5,3.1,19.7,2.5,27.1,7.2
          ...
          <path
            ref={path25}
            className="st0"
            d="M107.3,518.9c0.3,0.2,0,0.7-0.3,0.6c-10.1-3.9-18.6-10-27.7-15.8c-7.6-4.9-21.1-8.4-26.6-14.9
				c14.4-8.2,20.1,0.7,29.9,9.6C88.8,504.1,103.2,515.3,107.3,518.9z"
          />
          <path
            ref={path26}
            className="st0"
            d="M181,488.7c-2,12.5-37.1,51.1-49.9,54.7c-3-11.7,17.1-18.2,24.5-24.8c5-4.5,9.4-9.7,13.2-15.3
				c2.6-3.8,5.9-14.4,11.3-15.5C180.6,487.7,181.1,488.1,181,488.7z"
          />
          <path
            ref={path27}
            className="st0"
            d="M70.6,438c0.7,7.9-0.7,15.7,0.4,23.7c1,7,4.6,13.4,3.7,20.4c-10.2-6.6-11-21.6-12.2-32.7
				c-2.4,1.1-4.7,0.9-6.9-0.5C58.4,444.1,66,440.9,70.6,438z"
          />
          <path
            ref={path28}
            className="st0"
            d="M124.1,523.3c-1.1-3-2.3-6.2-3.4-9.4c-0.2-0.6,0.3-1.3,1-1.1c3.5,0.9,12.2,3,19.5-1.2
				c9-5.2,29.1-19,27.5-15.3C168.3,497.3,140.9,518.1,124.1,523.3z"
          />
          <path
            ref={path29}
            className="st0"
            d="M188.9,416.3c-10.7-3.7-21.3-8-32.2-11.8c-12.1-4.2-19.6-8.2-15.8-21.6c0.5-0.1,1-0.2,1.5-0.3
				c6.1,10.9,7.3,14.7,19.9,19.1c9.2,3.2,21.4,5.8,27.8,13.4C189.7,415.5,189.3,415.9,188.9,416.3z"
          />
          <path
            ref={path30}
            className="st0"
            d="M171.8,531.5c-0.3,0.3-0.8,0-0.6-0.4c2.5-7,5.2-13.7,8.3-20.4c2.7-5.7,3.1-10,9.2-7c0.5,0.3,0.7,0.9,0.4,1.4
				C184.3,513,175.1,527.5,171.8,531.5z"
          />
          <path
            ref={path31}
            className="st0"
            d="M88.9,557.1c1.8-3.8,2.3,35.8,0,43.5C88.9,585.9,87.7,559.6,88.9,557.1z"
          />
          <path
            ref={path32}
            className="st0"
            d="M94.6,601.9c0-10.3,0-20.7,0-31c0-1.9,0.6-2.4,0.9-1.5C97.6,579.8,95.7,591.6,94.6,601.9z"
          />
          <path
            ref={path33}
            className="st0"
            d="M101.1,612.2c-1.5,3.7-1.5-36.2,0-28.7C101.2,583.7,102.1,609.7,101.1,612.2z"
          />
          <path
            ref={path34}
            className="st0"
            d="M127.8,162.5c-0.4,0.5-1.2,0.2-1.2-0.5c0.1-2.6,0.4-6.4-3-3c-7.9,7.8-20,37.6-25.3,34.7
          ...
          <path
            ref={path35}
            className="st0"
            d="M143,299c-8.2-3.4,2.3-16,4.9-21.2c2-4.1,10.6-29.7,15.9-23.9c3.7-6.2,7.2-12,11-18.3c1.5,1,2.4,1.7,3.6,2.5
          ...
          <path
            ref={path36}
            className="st0"
            d="M119.5,196.1c-0.9,0.9-2.4,0.7-3-0.5l-0.6-1.2c-5.1,8.8-16.9,28.9-18.8,30.4c-5.8,4.6,14-34.3,18.3-38.5
          ...
          <path
            ref={path37}
            className="st0"
            d="M193.5,147.6L193.5,147.6c0.6,1,1.9,1.2,2.8,0.6c4.9-3.4,9.7-10.4,9.5-5.7c-0.1,2.3-45.5,42.7-53.8,56.4
          ...
          <path
            ref={path38}
            className="st0"
            d="M167.7,193.9c5.4,5.2,5.4,5.6,0.4,10.8c-6.6-6.9-32,28.3-35.8,33.3c-2.1,2.8-5,7.7-8,9.7
          ...
          <path
            ref={path39}
            className="st0"
            d="M118.4,262.2c-4.8,4.1-4.4,11.8-10.1,15.2c-0.4-0.2-0.8-0.4-1.3-0.6c1.3-4.6,9.3-26.7,15.7-21.5
				c10.3-10.7,16.6-24.2,27.2-34.3c5.8,3.7-11.7,22.3-14.8,26.7C130.8,253.6,127,264.6,118.4,262.2z"
          />
          <path
            ref={path40}
            className="st0"
            d="M62.5,270.9c0.8-12.8,8.9-44.2,21.4-48.2c0.6-0.2,1.1,0.3,1.1,0.9c0.1,3.9-3.4,5.6-5.7,9.1
				c-2.9,4.5-4.6,9.5-6,14.7c-2,7.5-7.5,19.6-9.9,23.8C63.2,271.7,62.4,271.5,62.5,270.9z"
          />
          <path
            ref={path41}
            className="st0"
            d="M213.4,99.1c4.3,4.5-3.1,3.1-14.8,9.4c-8.3,4.5-16.6,15.3-21.1,20.1C175.1,114.5,208.6,94,213.4,99.1z"
          />
          <path
            ref={path42}
            className="st0"
            d="M218.7,268.6c3.2,0.9-7.9,11.5-5.4,6c2-4.5-6.5-0.1-12.9,7.6c-10.7,12.8-7.2,13.5-8.9,14.1
				C181.8,299.7,204.2,264.4,218.7,268.6z"
          />
          <path
            ref={path43}
            className="st0"
            d="M113.1,231.8c-1.7-8.5,15.3-27.7,14-22.4C126.9,209.7,113.5,236.4,113.1,231.8z"
          />
          <path
            ref={path44}
            className="st0"
            d="M176.6,593.8l23-20.9c0.8-3.9-24.2,17.6-30.8,23.9c-0.7,0.7-0.3,1.8,0.7,1.9l9,0.2
          ...
          <path
            ref={path45}
            className="st0"
            d="M202.7,603.9c16.4-6.3-5.8,10.4-6.2,2c-0.3-5.8,14.1-19,20.4-22c0.5-0.2,1,0.3,0.7,0.7
				C213.7,592.8,195.4,606.7,202.7,603.9z"
          />
          <path
            ref={path46}
            className="st0"
            d="M130.4,626.8l23-20.9c0.8-3.9-24.2,17.6-30.8,23.9c-0.7,0.7-0.3,1.8,0.7,1.9c0,0,4.1,0.9,9,0.2
		...
		C128,628.8,129.9,627.2,130.4,626.8z"
          ...
          <path
            ref={path47}
            className="st0"
            d="M81.6,547.4c1.8-3.8,2.3,35.8,0,43.5C81.6,576.2,80.4,549.9,81.6,547.4z"
          />
          <path
            ref={path48}
            className="st0"
            d="M75.4,540.6c1.8-3.8,2.3,35.8,0,43.5C75.4,569.4,74.2,543.1,75.4,540.6z"
          />
          <path
            ref={path49}
            className="st0"
            d="M69,530.6c1.8-3.8,2.3,35.8,0,43.5C69,559.3,67.8,533.1,69,530.6z"
          />
          <path
            ref={path50}
            className="st0"
            d="M61.3,518.8c1.8-3.8,2.3,35.8,0,43.5C61.3,547.5,60.1,521.3,61.3,518.8z"
          />
          <path
            ref={path51}
            className="st0"
            d="M53.9,508.7c1.8-3.8,2.3,35.8,0,43.5C53.9,537.5,52.7,511.2,53.9,508.7z"
          />
          <path
            ref={path52}
            className="st0"
            d="M47,498.4c1.8-3.8,2.3,35.8,0,43.5C47,527.2,45.8,501,47,498.4z"
          />
          <path
            ref={path53}
            className="st0"
            d="M98.1,239.7c-0.9,5.6-11.3,16.6-14.1,18.1c-0.3,0.1-0.6-0.1-0.5-0.4c1.4-7.4,10.4-15.8,13.6-18.3
